...
class Db_object {
    ...
    UPLOAD_ERR_FORM_SIZE  => "The upload file exceeds the MAX_FILE_SIZE directive that was specified in the HTML",
...
public static function find_by_id($id) {
    ...
    //$founded_users = mysqli_fetch_array( $the_result_array);
   //if(!empty($the_result_arrray)) {
   //$first_item = array_shift($the_result_arrray);
   //return $first_item;
   //}else {
